...
def load_data(num_seeds=5, episodes=400):
...
def main():
    # 1. Crear directorio para las figuras (Obligatorio)
    ...
    # 3. Cálculos Estadísticos Oficiales (Parte I del Boletín)
    # Puntuación de convergencia (media del 10% final)
    ...
    print("\n--- RESULTADOS ESTADÍSTICOS PARA LA MEMORIA ---")
